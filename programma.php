    ...
    <main>
        <div class="programma-navigation">
            <div class="programma-links">
                <ul class="programma-list">
                    <li class="programma-item active"><a href="programma.html" class="nav-link">Overzicht</a></li>
        ...
        <section id="programma">
            <div class="row g-3">
                <div class="col-lg-4">
                    <div class="kaart"
                        style="background-image: url('assets/images/cesar.jpg');">
                ...
                <div class="col-lg-4">
                    <div class="kaart"
                        style="background-image: url('assets/images/erik\ hartman.jpg');">
                        <div class="programma-title">
                            <h4>Erik Hartman</h4>
                        </div>
                        <div class="programma-text">
                ...
                <div class="col-lg-4">
                    <div class="kaart"
                        style="background-image: url('assets/images/team\ lazer\ beam.jpg');">
                        <div class="programma-title">
                ...
                <div class="col-lg-4">
                    <div class="kaart"
                        style="background-image: url('assets/images/frankie\ loosveld.jpg');">
                        <div class="programma-title">
